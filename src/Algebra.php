...
class Algebra
{
     ...
     */
    public static function quadratic($a, $b, $c, $return_complex = false)
    {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public static function cubic($a₃, $a₂, $a₁, $a₀, $return_complex = false)
    {
        if ($a₃ == 0) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public static function quartic($a₄, $a₃, $a₂, $a₁, $a₀, $return_complex = false)
    {
