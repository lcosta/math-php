...
class Basic
{
     ...
     */
    public static function arithmeticProgression($n, $d, $a₁)
    {
        if ($n <= 0) {
            return [];
        }
     ...
     */
    public static function geometricProgression($n, $a, $r)
    {
        if ($r === 0) {
     ...
     */
    public static function squareNumber($n)
    {
        $squares = [];
        if ($n <= 0) {
            return $squares;
     ...
     */
    public static function cubicNumber($n)
    {
        $cubes = [];
        if ($n <= 0) {
            return $cubes;
     ...
     */
    public static function powersOfTwo($n)
    {
        $powers_of_2 = [];
        if ($n <= 0) {
            return $powers_of_2;
     ...
     */
    public static function powersOfTen($n)
    {
        $powers_of_10 = [];
        if ($n <= 0) {
            return $powers_of_10;
     ...
     * @return array Indexed from 0 (indexes are the n in the digitSum(n))
     */
    public static function digitalRoot($n)
    {
        if ($n <= 0) {
            return [];
        }
