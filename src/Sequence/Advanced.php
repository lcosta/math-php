...
class Advanced
{
     ...
     * @return array Indexed from 0
     */
    public static function lucasNumber($n)
    {
        $lucas = [];
        // Bad input; return empty list
        if ($n <= 0) {
     ...
     * @return array Indexed from 0
     */
    public static function pellNumber($n)
    {
        $pell = [];
        // Bad input; return empty list
        if ($n <= 0) {
     ...
     */
    public static function triangularNumber($n)
    {
        $triangular = [];
        // Bad input; return empty list
        if ($n <= 0) {
     ...
     * @return array Indexed from 1
     */
    public static function pentagonalNumber($n)
    {
        $pentagonal = [];
        // Bad input; return empty list
        if ($n <= 0) {
     ...
     * @return array Indexed from 1
     */
    public static function hexagonalNumber($n)
    {
        $hexagonal = [];
        // Bad input; return empty list
        if ($n <= 0) {
     ...
     * @return array Indexed from 1
     */
    public static function heptagonalNumber($n)
    {
        $heptagonal = [];
        // Bad input; return empty list
        if ($n <= 0) {
     ...
     */
    public static function lookAndSay($n)
    {
        if ($n <= 0) {
            return [];
        }
     ...
     * @return array
     */
    public static function lazyCaterers($n)
    {
        if ($n < 0) {
            return [];
        }
     ...
     * @return array
     */
    public static function magicSquares($n)
    {
        if ($n < 0) {
            return [];
        }
    ...
    const PERFECT_NUMBERS = [6, 28, 496, 8128, 33550336, 8589869056, 137438691328, 2305843008139952128, 2.658455991569832E+36, 1.915619426082361E+53];
    /**
     * Perfect numbers
     ...
     */
    public static function perfectNumbers($n)
    {
        if ($n <= 0) {
            return [];
        }
     ...
     * @return array
     */
    public static function perfectPowers($n)
    {
        $pp = [];
        if ($n <= 0) {
            return $pp;
     ...
     * @return array
     */
    public static function notPerfectPowers($n)
    {
        $npp = [];
        if ($n <= 0) {
            return $npp;
     ...
     * @return array
     */
    public static function primesUpTo($n)
    {
        if ($n < 2) {
            return [];
        }
