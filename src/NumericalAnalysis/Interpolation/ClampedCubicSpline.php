...
class ClampedCubicSpline extends Interpolation
{
     ...
     */
    public static function getSplinePoints($source, array $args = [])
    {
     ...
     * @return array
     */
    protected static function functionToSplinePoints(callable $function, callable $derivative, $start, $end, $n)
    {
        $points = [];
        $h = ($end - $start) / ($n - 1);
        for ($i = 0; $i < $n; $i++) {
     ...
     */
    public static function validateSpline(array $points, $degree = 2)
    {
