...
class Single
{
     ...
     * @return array
     */
    public static function add(array $xs, $k)
    {
     ...
     * @return array
     */
    public static function subtract(array $xs, $k)
    {
        return array_map(function ($x) use($k) {
            return $x - $k;
        }, $xs);
     ...
     * @return array
     */
    public static function multiply(array $xs, $k)
    {
        return array_map(function ($x) use($k) {
            return $x * $k;
        }, $xs);
     ...
     * @return array
     */
    public static function divide(array $xs, $k)
    {
        return array_map(function ($x) use($k) {
            return $x / $k;
        }, $xs);
     ...
     * @return array
     */
    public static function square(array $xs)
    {
     ...
     * @return array
     */
    public static function cube(array $xs)
    {
        return array_map(function ($x) {
            return $x ** 3;
        }, $xs);
     ...
     */
    public static function reciprocal(array $xs)
    {
        $zeros = array_filter($xs, function ($x) {
            return $x == 0;
        });
        if (!empty($zeros)) {
     ...
     * @return array
     */
    public static function pow(array $xs, $n)
    {
     ...
     * @return array
     */
    public static function sqrt(array $xs)
    {
        return array_map(function ($x) {
            return sqrt($x);
        }, $xs);
     ...
     * @return array
     */
    public static function abs(array $xs)
    {
        return array_map(function ($x) {
            return abs($x);
        }, $xs);
     ...
     * @return array
     */
    public static function min(array $xs, $value)
    {
     ...
     * @return array
     */
    public static function max(array $xs, $value)
    {
        return array_map(function ($x) use($value) {
            return max($x, $value);
        }, $xs);
