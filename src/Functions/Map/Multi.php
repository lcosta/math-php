...
class Multi
{
     ...
     */
    public static function add(array ...$arrays)
    {
     ...
     * @throws Exception\BadDataException
     */
    public static function subtract(array ...$arrays)
    {
        self::checkArrayLengths($arrays);
        $number_of_arrays = count($arrays);
        $length_of_arrays = count($arrays[0]);
     ...
     * @throws Exception\BadDataException
     */
    public static function divide(array ...$arrays)
    {
        self::checkArrayLengths($arrays);
        $number_of_arrays = count($arrays);
        $length_of_arrays = count($arrays[0]);
     ...
     * @throws Exception\BadDataException
     */
    public static function max(array ...$arrays)
    {
        self::checkArrayLengths($arrays);
        $number_of_arrays = count($arrays);
        $length_of_arrays = count($arrays[0]);
     ...
     * @throws Exception\BadDataException
     */
    public static function min(array ...$arrays)
    {
        self::checkArrayLengths($arrays);
        $number_of_arrays = count($arrays);
        $length_of_arrays = count($arrays[0]);
     ...
     */
    private static function checkArrayLengths(array $arrays)
    {
        if (count($arrays) < 2) {
