...
class Support
{
     ...
     */
    public static function isZero($x, $ε = self::ε)
    {
        return $x == 0 || abs($x) <= $ε;
    }
    /**
     ...
     */
    public static function isNotZero($x, $ε = self::ε)
    {
        return $x != 0 && abs($x) > $ε;
    }
    /**
     ...
     * @return bool
     */
    public static function isEqual($x, $y, $ε = self::ε)
    {
     ...
     * @return bool
     */
    public static function isNotEqual($x, $y, $ε = self::ε)
    {
        return $x != $y && abs($x - $y) >= $ε;
    }
}