...
class Finance
{
     ...
     * @return float
     */
    public static function irr(array $values, $initial_guess = 0.1)
    {
     ...
     * @return float
     */
    public static function mirr(array $values, $finance_rate, $reinvestment_rate)
    {
        $inflows = array();
        $outflows = array();
     ...
     * @return float
     */
    public static function payback(array $values, $rate = 0.0)
    {
        $last_outflow = -1;
        for ($i = 0; $i < sizeof($values); $i++) {
            if ($values[$i] < 0) {
     ...
     * @return float
     */
    public static function profitabilityIndex(array $values, $rate)
    {
        $inflows = array();
        $outflows = array();
        for ($i = 0; $i < sizeof($values); $i++) {
