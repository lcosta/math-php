...
class Arithmetic
{
     ...
     * @return float
     */
    public static function root($x, $nᵗʰ)
    {
        if ($x >= 0 || $nᵗʰ % 2 === 0) {
            return pow($x, 1 / $nᵗʰ);
        }
     ...
     * @return int
     */
    public static function digitalRoot($x)
    {
        $root = $x;
        while ($root >= 10) {
     ...
     */
    public static function almostEqual($x, $y, $ε = 1.0E-12)
    {
        return abs($x - $y) <= $ε;
    }
    /**
     ...
     */
    public static function copySign($magnitude, $sign)
    {
