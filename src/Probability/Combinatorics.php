...
class Combinatorics
{
     ...
     * @throws Exception\OutOfBoundsException if n < 0
     */
    public static function doubleFactorial($n)
    {
        if ($n < 0) {
     ...
     * @throws Exception\OutOfBoundsException if n < 0
     */
    public static function risingFactorial($x, $n)
    {
        if ($n < 0) {
     ...
     * @throws Exception\OutOfBoundsException if n < 0
     */
    public static function fallingFactorial($x, $n)
    {
        if ($n < 0) {
            throw new Exception\OutOfBoundsException('Cannot compute rising factorial of a negative number.');
        }
     ...
     * @throws Exception\OutOfBoundsException if n < 0
     */
    public static function subfactorial($n)
    {
        if ($n < 0) {
     ...
     */
    public static function permutations($n, $k = null)
    {
        if ($n < 0) {
     ...
     */
    public static function combinations($n, $k, $repetition = false)
    {
        if ($n < 0) {
     ...
     * @throws Exception\OutOfBoundsException if n < 0
     */
    public static function centralBinomialCoefficient($n)
    {
        if ($n < 0) {
     ...
     * @throws Exception\OutOfBoundsException if n < 0
     */
    public static function catalanNumber($n)
    {
        if ($n < 0) {
     ...
     */
    public static function lahNumber($n, $k)
    {
        if ($n < 1 || $k < 1) {
