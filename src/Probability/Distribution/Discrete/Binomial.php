...
class Binomial extends Discrete
{
     ...
     * @var array
     */
    const PARAMETER_LIMITS = ['n' => '[0,∞)', 'p' => '[0,1]'];
    /**
     * Distribution support bounds limits
     * r ∈ [0,∞)
     * @var array
     */
    const SUPPORT_LIMITS = ['r' => '[0,∞)'];
     ...
     */
    private function combinatorialMethod($r)
    {
        $n = $this->n;
        $p = $this->p;
     ...
     * @return float
     */
    private function multiplicationMethod($r, $n, $p)
    {
        if (2 * $r > $n) {
