...
class Average
{
     ...
     */
    public static function kthSmallest(array $numbers, $k)
    {
        $n = count($numbers);
        if ($n === 0) {
     ...
     * @return array
     */
    private static function splitAtValue(array $numbers, $value)
    {
        $lower = [];
        $upper = [];
        $number_equal = 0;
     ...
     * @throws Exception\BadDataException if the input array of numbers is empty
     */
    public static function truncatedMean(array $numbers, $trim_percent)
    {
        if (empty($numbers)) {
     ...
     */
    public static function simpleMovingAverage(array $numbers, $n)
    {
        $m = count($numbers);
        $SMA = [];
        // Counters
     ...
     */
    public static function cumulativeMovingAverage(array $numbers)
    {
        $m = count($numbers);
        $CMA = [];
     ...
     */
    public static function weightedMovingAverage(array $numbers, $n, array $weights)
    {
        if (count($weights) !== $n) {
     ...
     */
    public static function exponentialMovingAverage(array $numbers, $n)
    {
        $m = count($numbers);
        $α = 2 / ($n + 1);
        $EMA = [];
     ...
     * @return float
     */
    public static function arithmeticGeometricMean($x, $y)
    {
        // x or y < 0 = NaN
        if ($x < 0 || $y < 0) {
            return \NAN;
     ...
     * @return float
     */
    public static function agm($x, $y)
    {
     ...
     * @throws Exception\OutOfBoundsException
     */
    public static function describe(array $numbers)
    {
