...
class Circular
{
     ...
     */
    public static function mean(array $angles)
    {
     ...
     * @return float
     */
    public static function resultantLength(array $angles)
    {
     ...
     * @return float
     */
    public static function meanResultantLength(array $angles)
    {
        $n = count($angles);
     ...
     * @return float
     */
    public static function variance(array $angles)
    {
     ...
     * @return float
     */
    public static function standardDeviation(array $angles)
    {
        $ρ = self::meanResultantLength($angles);
        $√⟮−2ln⟮R⟯⟯ = sqrt(-2 * log($ρ));
        return $√⟮−2ln⟮R⟯⟯;
     ...
     */
    public static function describe(array $angles)
    {
