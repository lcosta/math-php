...
class Correlation
{
     ...
     */
    public static function covariance(array $X, array $Y, $population = false)
    {
     ...
     * @throws Exception\BadDataException if X and Y do not have the same number of elements
     */
    public static function weightedCovariance(array $X, array $Y, array $w)
    {
     ...
     */
    public static function r(array $X, array $Y, $population = false)
    {
     ...
     * @throws Exception\OutOfBoundsException
     */
    public static function r2(array $X, array $Y, $popluation = false)
    {
     ...
     * @throws Exception\OutOfBoundsException
     */
    public static function coefficientOfDetermination(array $X, array $Y, $popluation = false)
    {
        return pow(self::r($X, $Y, $popluation), 2);
    }
    /**
     ...
     * @throws Exception\BadDataException
     */
    public static function weightedCorrelationCoefficient(array $X, array $Y, array $w)
    {
     ...
     * @throws Exception\OutOfBoundsException
     */
    public static function describe(array $X, array $Y, $population = false)
    {
     ...
     * @throws Exception\OutOfBoundsException
     */
    public static function confidenceEllipse(array $X, array $Y, $z, $num_points = 11)
    {
