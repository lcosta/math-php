...
class Experiment
{
     ...
     */
    public static function riskRatio($a, $b, $c, $d)
    {
        // Risk ratio
        $RR = $a / ($a + $b) / ($c / ($c + $d));
        // Standard error of the log relative risk
     ...
     */
    public static function oddsRatio($a, $b, $c, $d)
    {
        // Odds ratio
        $OR = $a / $b / ($c / $d);
        // Standard error of the log odds ratio
     ...
     * @return array [ LL+, LL- ]
     */
    public static function likelihoodRatio($a, $b, $c, $d)
    {
     ...
     */
    public static function likelihoodRatioSS($sensitivity, $specificity)
    {
