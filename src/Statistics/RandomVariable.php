...
class RandomVariable
{
     ...
     * @throws Exception\BadDataException if the input array of numbers is empty
     */
    public static function isPlatykurtic(array $X)
    {
     ...
     * @throws Exception\BadDataException if the input array of numbers is empty
     */
    public static function isLeptokurtic(array $X)
    {
        return self::kurtosis($X) > 0;
    }
    /**
     ...
     * @throws Exception\BadDataException if the input array of numbers is empty
     */
    public static function isMesokurtic(array $X)
    {
        return self::kurtosis($X) == 0;
    }
    /**
     ...
     * @throws Exception\BadDataException if the input array of numbers is empty
     */
    public static function sem(array $X)
    {
     ...
     */
    public static function confidenceInterval($μ, $n, $σ, $cl)
    {
        if ($n === 0) {
