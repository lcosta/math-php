...
class Outlier
{
     ...
     */
    public static function grubbsStatistic(array $data, $typeOfTest = self::TWO_SIDED)
    {
        $μ = Average::mean($data);
     ...
     */
    public static function grubbsCriticalValue($𝛼, $n, $typeOfTest)
    {
     ...
     * @throws Exception\BadParameterException
     */
    private static function validateGrubbsCriticalValueTestType($typeOfTest)
    {
