...
class KernelDensityEstimation
{
     ...
     */
    public function __construct(array $data, $h = null, $kernel = null)
    {
        $this->n = count($data);
        if ($this->n === 0) {
     ...
     */
    public function setBandwidth($h = null)
    {
        if ($h === null) {
     ...
     */
    private function getDefaultBandwidth()
    {
     ...
     * @throws Exception\OutOfBoundsException
     */
    private function getKernelFunctionFromLibrary($kernel)
    {
        switch ($kernel) {
