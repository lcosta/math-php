...
class Eigenvector
{
     ...
     */
    public static function eigenvectors(Matrix $A, array $eigenvalues = [])
    {
     ...
     * @return int
     */
    private static function countSolutions(Matrix $M)
    {
     ...
     * @return array
     */
    private static function findZeroColumns(Matrix $M)
    {
        $m = $M->getM();
        $zero_columns = [];
        for ($i = 0; $i < $M->getN(); $i++) {
