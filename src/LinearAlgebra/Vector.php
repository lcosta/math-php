...
class Vector implements \Countable, \Iterator, \ArrayAccess, \JsonSerializable
{
     ...
     * @throws Exception\BadDataException
     */
    public function multiply(Vector $B)
    {
        if ($B->getN() !== $this->n) {
     ...
     * @return Matrix
     */
    public function directProduct(Vector $B)
    {
     ...
     * @return Vector
     */
    public function projection(Vector $B)
    {
     ...
     * @return Vector
     */
    public function kroneckerProduct(Vector $B)
    {
        $A = $this->asColumnMatrix();
        $B = $B->asColumnMatrix();
