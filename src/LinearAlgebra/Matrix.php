...
class Matrix implements \ArrayAccess, \JsonSerializable
{
     ...
     * @return bool
     */
    public function isEqual(Matrix $B)
    {
        $m = $this->m;
        $n = $this->n;
        $ε = $this->ε;
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function augment(Matrix $B)
    {
        if ($B->getM() !== $this->m) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function augmentLeft(Matrix $B)
    {
        if ($B->getM() !== $this->m) {
            throw new Exception\MatrixException('Matrices to augment do not have the same number of rows');
        }
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function augmentBelow(Matrix $B)
    {
        if ($B->getN() !== $this->n) {
     ...
     * @throws Exception\MatrixException
     */
    public function augmentAbove(Matrix $B)
    {
        if ($B->getN() !== $this->n) {
            throw new Exception\MatrixException('Matrices to augment do not have the same number of columns');
        }
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function directSum(Matrix $B)
    {
        $m = $this->m + $B->getM();
        $n = $this->n + $B->getN();
        $R = [];
     ...
     * @throws Exception\BadDataException
     */
    public function kroneckerSum(Matrix $B)
    {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function scalarMultiply($λ)
    {
        $R = [];
        for ($i = 0; $i < $this->m; $i++) {
            for ($j = 0; $j < $this->n; $j++) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function scalarDivide($λ)
    {
        if ($λ == 0) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function hadamardProduct(Matrix $B)
    {
     ...
     * @throws Exception\BadDataException
     */
    public function kroneckerProduct(Matrix $B)
    {
        ...
        foreach ($arrays as $row) {
            ...
            $matrices[] = array_reduce($row, function (Matrix $augmented_matrix, Matrix $matrix) {
                return $augmented_matrix->augment($matrix);
            }, $initial_matrix);
        }
        // Augment below each row block a₁ to am
        $initial_matrix = array_shift($matrices);
        $A⊗B = array_reduce($matrices, function (Matrix $augmented_matrix, Matrix $matrix) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function minorMatrix($mᵢ, $nⱼ)
    {
        if (!$this->isSquare()) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function leadingPrincipalMinor($k)
    {
        if ($k <= 0) {
     ...
     * @throws Exception\MatrixException
     */
    public function submatrix($m₁, $n₁, $m₂, $n₂)
    {
     ...
     * @throws Exception\MatrixException
     */
    public function insert(Matrix $small, $m, $n)
    {
     ...
     */
    public function vectorMultiply(Vector $B)
    {
        $B = $B->getVector();
        $n = count($B);
        $m = $this->m;
     ...
     * @throws Exception\BadParameterException
     */
    public function cofactor($mᵢ, $nⱼ)
    {
        if (!$this->isSquare()) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function rowInterchange($mᵢ, $mⱼ)
    {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function rowMultiply($mᵢ, $k)
    {
        if ($mᵢ >= $this->m) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function rowDivide($mᵢ, $k)
    {
        if ($mᵢ >= $this->m) {
            throw new Exception\MatrixException('Row to multiply does not exist');
        }
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function rowAdd($mᵢ, $mⱼ, $k)
    {
        if ($mᵢ >= $this->m || $mⱼ >= $this->m) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function rowAddScalar($mᵢ, $k)
    {
        if ($mᵢ >= $this->m) {
            throw new Exception\MatrixException('Row to add does not exist');
        }
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function rowSubtract($mᵢ, $mⱼ, $k)
    {
        if ($mᵢ >= $this->m || $mⱼ >= $this->m) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function rowSubtractScalar($mᵢ, $k)
    {
        if ($mᵢ >= $this->m) {
            throw new Exception\MatrixException('Row to subtract does not exist');
        }
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function columnInterchange($nᵢ, $nⱼ)
    {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function columnMultiply($nᵢ, $k)
    {
        if ($nᵢ >= $this->n) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function columnAdd($nᵢ, $nⱼ, $k)
    {
        if ($nᵢ >= $this->n || $nⱼ >= $this->n) {
     ...
     * @throws Exception\IncorrectTypeException
     */
    public function columnExclude($nᵢ)
    {
        if ($nᵢ >= $this->n || $nᵢ < 0) {
     ...
     * @throws Exception\MathException
     */
    public function qrDecomposition()
    {
     ...
     * @throws Exception\MathException
     */
    public function eigenvalues($method = null)
    {
        if (!$this->isSquare()) {
     ...
     * @throws Exception\MathException
     */
    public function eigenvectors($method = null)
    {
        if ($method === null) {
    ...
    {
        return trim(array_reduce(array_map(function ($mᵢ) {
            return '[' . implode(', ', $mᵢ) . ']';
